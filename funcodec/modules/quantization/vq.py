...
from funcodec.modules.quantization.core_vq import ResidualVectorQuantization
from funcodec.modules.quantization.ddp_core_vq import DistributedResidualVectorQuantization
